...
return (
    ...
    <div className="grid lg:grid-cols-2 bg-sand text-white">
        <div className="flex flex-col px-16 justify-center">
            ...
            <p className="text-sm uppercase mt-5 flex gap-5 items-center"><PiPlantFill /> Featured Post <PiPlantFill /></p>
            <h2 className="text-2xl my-5 font-semibold">Five Benefits of Soapless Cleansers</h2>
            <p className="w-3/4">We explore the huge differences using a soapless cleanser can make for your skin. It's time to stop using harsh chemicals and let the plants use their power.</p>
            <Link href="/blog/soapless-cleansers" className="px-5 py-2 border border-white mt-7 inline">Read More</Link>
        </div>
